...
{
    public sealed class ClsNConvertidor
    {
        ...
        public const String MascaraSalidaDecimalDefault = "00'/100. centimos'";
        ...
        public ClsNConvertidor(Boolean ConvertirDecimales, String MascaraSalidaDecimal, String SeparadorDecimalSalida, Boolean LetraCapital)
        {
        ...
        {
            return ClsNConvertidor.ToCardinal(Numero, CultureInfo.CurrentCulture);
        }
